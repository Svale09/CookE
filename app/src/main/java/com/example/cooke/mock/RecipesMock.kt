...
object RecipesMock {
    ...
    fun getRecipeDetails(): RecipeDetails = RecipeDetails(
        ...
        difficulty = "Intermediate",
        ingridients = "4 large egg yolks, 1/2 cups of 100 grams granulated sugar, 3/4 cup heavy cream, 220 grams mascarpone, 1 and 3/4 of espresso, " +
                "24 ladydingers, 2 tbsp rum, 2 tbsp unsweetened cocoa, 2 ounces bittersweet chocolate",
        preparation = listOf("Using an electric mixer in a medium bowl, whip together egg yolks and ¼ cup/50 grams sugar until very pale yellow and about tripled in volume. A slight ribbon should fall from the beaters (or whisk attachment) when lifted from the bowl. Transfer mixture to a large bowl, wiping out the medium bowl used to whip the yolks and set aside.",
